...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0078FF);
  late Color secondary = const Color(0xFF00C4FF);
  late Color tertiary = const Color(0xFF00FFD9);
  late Color alternate = const Color(0xFFFFA600);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFC2CBE6);
  late Color primaryBackground = const Color(0xFFF2F6FF);
  late Color secondaryBackground = const Color(0xFFE6EEFF);
  late Color accent1 = const Color(0xFFFF006E);
  late Color accent2 = const Color(0xFFFFD800);
  late Color accent3 = const Color(0xFF00FFA2);
  late Color accent4 = const Color(0xFFFF00B4);
  late Color success = const Color(0xFF00D979);
  late Color warning = const Color(0xFFFFB800);
  late Color error = const Color(0xFFFF3E3E);
  late Color info = const Color(0xFF006EFF);
