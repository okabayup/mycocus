                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'kilp0czt' /* Aktifkan Masuk dengan Sidik Ja... */,
                        ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '8cx7u94n' /* Jika kamu mengaktifkan masuk d... */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Poppins',
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (isBiometricSupported && canCheckBiometrics) {
                      _model.sidikjari = await localAuth.authenticate(
                          localizedReason: FFLocalizations.of(context).getText(
                            '5qmfmbr3' /* Mohon autentikasi untuk masuk ... */,
                          ),
                          options:
                    ...
                    if (_model.sidikjari) {
                      FFAppState().sidikjari = true;

                      context.pushNamed('TurnOnNotification');
                    }
