...
class DetailProdukWidget extends StatefulWidget {
  ...
  final DocumentReference? produk;
...
class _DetailProdukWidgetState extends State<DetailProdukWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductRecord>(
      stream: ProductRecord.getDocument(widget.produk!),
      builder: (context, snapshot) {
        ...
        final detailProdukProductRecord = snapshot.data!;
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(
                              detailProdukProductRecord.gambarProduk,
                            ),
                          ),
                        ),
                        child: Column(
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        valueOrDefault<String>(
                          formatNumber(
                            detailProdukProductRecord.hargaProduk,
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await launchURL(
                                    'https://cocus.caratani.id/product/${detailProdukProductRecord.reference.id}');
                              },
                              text: 'Beli via ${detailProdukProductRecord.via}',
                              icon: const FaIcon(
